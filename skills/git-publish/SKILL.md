...
4. Create the PR/MR with the enriched body:
   ...
   gh pr create --base main --head [RELEASE_BRANCH] \
     ...
     --body "$PR_BODY"
   # GitLab: glab mr create --target-branch main --source-branch [RELEASE_BRANCH] --title "${ARGUMENTS:-Release update}" --description "$PR_BODY"
   ```
...
# GitLab: glab mr create --target-branch main --source-branch [RELEASE_BRANCH] --title "${ARGUMENTS:-Release update}" --description "Merge [RELEASE_BRANCH] into main"
```
